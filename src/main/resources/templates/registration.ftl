...
<main class="container">
    <form action="/registration" method="post" class="border border-light p-5" autocomplete="on">
        ...
        <div class="form-group">
            ...
            <input type="password" name="password1" id="inputPassword" class="form-control mb-2 col-9 mx-auto" placeholder="Enter password" required maxlength="50">
        ...
        <div class="form-group">
            <label for="inputPassword" style="padding-left: 127px;">Email</label>
            <input type="email" name="email" id="inputEmail" class="form-control mb-2 col-9 mx-auto" placeholder="some@some.com" required maxlength="50">
        ...
        <div class="form-group">
            ...
            <input type="text" name="address" id="inputAddress" class="form-control col-9 mx-auto"
                   aria-describedby="addressHelp" placeholder="Enter home address" autofocus required maxlength="50">
