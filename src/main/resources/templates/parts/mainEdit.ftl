    ...
    <div class="container">
        ...
        <div class="my-5">
            ...
            <table class="container mt-4">
               <tr class="row">
                   <th class="col-1">Manufact.</th>
                   <th class="col-3">Model</th>
                   <th class="col-1">Monitor</th>
                   <th class="col-2">CPU</th>
                   <th class="col-1">RAM, Gb</th>
                   <th class="col-1">St. type</th>
                   <th class="col-1">St. site, Gb</th>
                   <th class="col-2">Video card</th>
               </tr>
            </table>
